...
struct ControlCommand {
    ...
    std::size_t setpoint_count;
    std::size_t impedance_setpoint_count;
    ...
    static ControlCommand set_position_targets_rad(std::vector<double> values) {
        ...
        cmd.setpoint_count = values.size();
    ...
    static ControlCommand set_position_target_rad(int motor_index, double value) {
        ControlCommand cmd;
        cmd.kind = ControlCommandKind::SETPOINT;
        cmd.setpoint_type = SetpointCommandType::POSITION_TARGETS;
        cmd.motor_index = motor_index;
    ...
    static ControlCommand set_velocity_target_rad_s(int motor_index, double value) {
        ControlCommand cmd;
        cmd.kind = ControlCommandKind::SETPOINT;
        cmd.setpoint_type = SetpointCommandType::VELOCITY_TARGETS;
        cmd.motor_index = motor_index;
    ...
    static ControlCommand set_torque_targets(std::vector<double> torque) {
        ...
        cmd.setpoint_count = torque.size();
    ...
    static ControlCommand set_torque_target(int motor_index, double torque) {
        ControlCommand cmd;
        cmd.kind = ControlCommandKind::SETPOINT;
        cmd.setpoint_type = SetpointCommandType::TORQUE_TARGETS;
        cmd.motor_index = motor_index;
        cmd.setpoint_count = 1;
        cmd.setpoints[0] = torque;
        return cmd;
    }
    ...
    static ControlCommand set_impedance_targets(std::vector<ImpedanceSetpoint> values) {
        ...
        cmd.impedance_setpoint_count = values.size();
        for (std::size_t i = 0; i < values.size(); ++i) {
    ...
    static ControlCommand set_impedance_target(int motor_index, const ImpedanceSetpoint& value) {
        ControlCommand cmd;
        cmd.kind = ControlCommandKind::SETPOINT;
        cmd.setpoint_type = SetpointCommandType::IMPEDANCE_TARGETS;
        cmd.motor_index = motor_index;
